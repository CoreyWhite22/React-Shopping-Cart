  ...
  let list = items.map((item, index) => {
    ...
    switch (item.name.trim().toLowerCase()) {
      ...
      case "cabbage":
        ...
        break;
      default:
        imgSrc = "placeholder.png"; // Fallback image if none of the cases match
    }
  
    let imagePath = `${imgSrc}`; // Adjust the path as necessary
  
    return (
      <li key={index}>
        <Image src={imagePath} width={70} roundedCircle></Image>
